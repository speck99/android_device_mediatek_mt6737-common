...
#define ATRACE_TAG_PERF ATRACE_TAG_GRAPHICS
...
public:
    ...
    bool isPendingRemoved() const { return m_is_pending_removed; }
    void remove() { m_is_pending_removed = true; }
...
public:
    ...
    void setValiPresentState(HWC_VALI_PRESENT_STATE val) { m_vali_present_state = val; }
...
/* Skip Validate */
    ...
    void setValiPresentStateOfAllDisplay(const HWC_VALI_PRESENT_STATE& val);
/*-------------------------------------------------------------------------*/
